...
const char* toString(InferenceId i)
{
  switch (i)
  {
    ...
    case InferenceId::QUANTIFIERS_CTX_ENUM: return "QUANTIFIERS_CTX_ENUM";
    case InferenceId::QUANTIFIERS_CONFLICT_CONJ_GEN_SPLIT:
      return "QUANTIFIERS_CONFLICT_CONJ_GEN_SPLIT";

...
/**
 * Attribute marked true for function symbols that are generated by the
 * contextual enumerator.  The enumerative conjecture generator ignores function
 * symbols for which this attribute is true.
 */
struct ContextualEnumeratorAttributeId
{
};
typedef expr::Attribute<ContextualEnumeratorAttributeId, bool> CtxtEnumAttribute;
